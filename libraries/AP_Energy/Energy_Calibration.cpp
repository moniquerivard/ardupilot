...
Energy_Calibration::Energy_Calibration(const AP_Vehicle::FixedWing &parms) :
    P(100,   0,         0,
      0,   100,         0,
      0,     0,  0.000001f),
    Q0(0.01f),
 ...
 */
void Energy_Calibration::init(float initial_ratio)
{
 ...
 */
float Energy_Calibration::update(float airspeed, const Vector3f &vg)
{
 ...
 */
void AP_Energy::update_calibration(const Vector3f &vground)
{
    if (!_autocal) {
...
void AP_Energy::log_mavlink_send(mavlink_channel_t chan, const Vector3f &vground)
{
